...
const ciudadesDisponiblesParaViajar = new Array(
  "Bogotá",
  "Lima",
  "Santiago",
  "Montevideo"
); //new Array es el prototipo para crear el array
...
if (
  ciudadesDisponiblesParaViajar.indexOf(ciudadDeDestino) > -1 &&
...
// A && B || C
if (
  ciudadesDisponibles2.indexOf(ciudadDestino2) > -1 &&
  edadPasajero2 >= 18 &&
  tienePasaporte &&
  !estaCasado
) {
